...
from play_DPSelect_punishOnlyRep_repInPlayState_centipede_caveman import \
    play_dp_s_play_punish_only_rep_rep_in_play_state_centipede_caveman
...
if __name__ == "__main__":
    ...
    NUM_AGENTS = 25
    COMMUNITY_SIZE = 5
    game_name = "play_dp_s_play_punish_only_rep_rep_in_play_state_centipede_caveman"
    ...
    for run in tqdm(range(NUM_RUNS)):
        ...
        mean_combined_sum_reward, agent_stats = play_dp_s_play_punish_only_rep_rep_in_play_state_centipede_caveman(NUM_EPISODES,
