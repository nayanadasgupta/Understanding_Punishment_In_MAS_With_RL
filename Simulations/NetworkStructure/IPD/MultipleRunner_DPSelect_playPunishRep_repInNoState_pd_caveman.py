...
from play_DPSelect_playPunishRep_repInNoState_pd_caveman import \
    play_dp_s_play_punish_rep_rep_in_no_state_caveman
...
if __name__ == "__main__":
    ...
    NUM_AGENTS = 25
    COMMUNITY_SIZE = 5
    game_name = "play_dp_s_play_punish_rep_rep_in_no_state_caveman"
