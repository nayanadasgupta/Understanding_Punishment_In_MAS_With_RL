...
def play_dp_play_punish_rep_rep_in_no_state(cooperation_dilemma: MatrixGame, num_eps: int, num_rounds: int,
...
if __name__ == "__main__":
    ...
    mean_combined_sum_reward, agent_stats = play_dp_play_punish_rep_rep_in_no_state(cooperation_game, 1000,
                                                                                      10, population)
