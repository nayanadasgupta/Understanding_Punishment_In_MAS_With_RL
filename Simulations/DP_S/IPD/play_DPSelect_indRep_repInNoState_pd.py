...
def play_dp_s_ind_rep_rep_in_no_state(cooperation_dilemma: MatrixGame, num_eps: int, num_rounds: int,
    ...
    for episode in tqdm(range(num_eps)):
        ...
        for agent_1_idx, agent_1 in enumerate(population):
            ...
            for round_idx in range(num_rounds):
                ...
                select_exp_1 = (
                    select_state[agent_1_idx], possible_partner_idx, play_reward_1, new_select_state_1[agent_1_idx], is_terminal_round)
    ...
    if logging:
        with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Logs', 'play_dp_s_ind_rep_rep_in_no_state.json'), 'w+', encoding='utf-8') as f:
...
if __name__ == "__main__":
    ...
    mean_combined_sum_reward, agent_stats = play_dp_s_ind_rep_rep_in_no_state(cooperation_game, 1000,
                                                                              10, population)
