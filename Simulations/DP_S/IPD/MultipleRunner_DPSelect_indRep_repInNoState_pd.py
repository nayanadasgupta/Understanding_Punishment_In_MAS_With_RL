...
from play_DPSelect_indRep_repInNoState_pd import play_dp_s_ind_rep_rep_in_no_state
...
if __name__ == "__main__":
    game_name = "play_dp_s_ind_rep_rep_in_no_state"
    run_stats = []
    ...
    for run in tqdm(range(NUM_RUNS)):
        ...
        mean_combined_sum_reward, agent_stats = play_dp_s_ind_rep_rep_in_no_state(cooperation_game,
                                                                                     NUM_EPISODES,
