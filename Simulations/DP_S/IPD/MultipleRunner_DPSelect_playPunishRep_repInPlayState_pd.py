...
from play_DPSelect_playPunishRep_repInPlayState_pd import play_dp_s_play_punish_rep_rep_in_play_state
...
if __name__ == "__main__":
    game_name = "play_dp_s_play_punish_rep_rep_in_play_state"
    run_stats = []
    ...
    for run in tqdm(range(NUM_RUNS)):
        ...
        mean_combined_sum_reward, agent_stats = play_dp_s_play_punish_rep_rep_in_play_state(cooperation_game,
                                                                                          NUM_EPISODES,
