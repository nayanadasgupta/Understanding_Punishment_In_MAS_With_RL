...
from play_DPSelect_punishOnlyRep_repInNoState_centipede import play_dp_s_play_punish_only_rep_rep_in_no_state_centipede
...
if __name__ == "__main__":
    game_name = "play_dp_s_play_punish_only_rep_rep_in_no_state_centipede"
    run_stats = []
    ...
    for run in tqdm(range(NUM_RUNS)):
        ...
        mean_combined_sum_reward, agent_stats = play_dp_s_play_punish_only_rep_rep_in_no_state_centipede(NUM_EPISODES,
                                                                                                                  NUM_ROUNDS,
                                                                                                                  population)
        print()
