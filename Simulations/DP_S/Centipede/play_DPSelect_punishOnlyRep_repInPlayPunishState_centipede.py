# Reputation impacted by punishing behaviour only. Play and punish actions also depend on reputation (play, punish state).
...
def play_dp_s_play_punish_only_rep_rep_in_play_punish_state_centipede(num_eps: int, max_num_rounds: int,
            ...
            for round_index in range(max_num_rounds):
                ...
                if cur_agent_turn == 0:
                    ...
                    punish_reward_1, running_reward_1, agent_stats = perform_punishment(punish_action_idx_1,
                                                                                        ...
                                                                                        logging, episode)
                    update_reputation_using_punish_action(punish_action_idx_1, play_action_idx_1, agent_2_idx,
                                                          agent_reputations)
                    ...
                    new_punish_state_1 = [play_action_idx_1, agent_prev_play_actions[agent_2_idx],
                                          agent_reputations[agent_2_idx], agent_reputations[agent_1_idx]]
                ...
                if stop_activated:
                    ...
                    punish_reward_2, running_reward_2, agent_stats = perform_punishment(punish_action_idx_2,
                                                                                        ...
                                                                                        agent_reputations, agent_stats,
                                                                                        logging, episode)
                    update_reputation_using_punish_action(punish_action_idx_2, play_action_idx_2, agent_1_idx,
                                                          agent_reputations)
                    ...
                    new_punish_state_2 = [play_action_idx_2, agent_prev_play_actions[agent_1_idx],
                                          agent_reputations[agent_1_idx], agent_reputations[agent_2_idx]]
    ...
    if logging:
        with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Logs',
                               'play_dp_s_play_punish_only_rep_rep_in_play_punish_state_centipede.json'), 'w+', encoding='utf-8') as f:
...
if __name__ == "__main__":
    ...
    mean_combined_sum_reward, agent_stats = play_dp_s_play_punish_only_rep_rep_in_play_punish_state_centipede(10, 2, population)
