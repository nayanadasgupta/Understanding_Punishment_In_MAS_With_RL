...
def play_ttpdp_s_play_punish_rep_rep_in_play_state(cooperation_dilemma: MatrixGame, num_eps: int, num_rounds: int,
    ...
    for episode in tqdm(range(num_eps)):
        ...
        for agent_1_idx, agent_1 in enumerate(population):
            ...
            if logging:
                ...
                flattened_agent_2_tpp_punish_history = [punish for episode in agent_stats[agent_2_idx]["tpp_punish_history"] for punish in episode]
                if len(flattened_agent_2_tpp_punish_history) > 0:
                    agent_stats[agent_1_idx]["prev_tpp_punish_select"].append((agent_2_idx, flattened_agent_2_tpp_punish_history[-1]))
                if len(agent_stats[agent_2_idx]["tpp_punish_justly"]) > 0:
                    agent_stats[agent_1_idx]["prev_tpp_punish_justly_select"].append((agent_2_idx, agent_stats[agent_2_idx]["tpp_punish_justly"][-1]))
                if len(agent_stats[agent_2_idx]["tpp_punish_unjustly"]) > 0:
                    agent_stats[agent_1_idx]["prev_tpp_punish_unjustly_select"].append((agent_2_idx, agent_stats[agent_2_idx]["tpp_punish_unjustly"][-1]))

                flattened_agent_2_direct_punish_history = [punish for episode in agent_stats[agent_2_idx]["tpp_punish_history"] for punish in episode]
                if len(flattened_agent_2_direct_punish_history) > 0:
                    agent_stats[agent_1_idx]["prev_direct_punish_select"].append((agent_2_idx, flattened_agent_2_direct_punish_history[-1]))
                if len(agent_stats[agent_2_idx]["direct_punish_justly"]) > 0:
                    agent_stats[agent_1_idx]["prev_direct_punish_justly_select"].append((agent_2_idx, agent_stats[agent_2_idx]["direct_punish_justly"][-1]))
                if len(agent_stats[agent_2_idx]["direct_punish_unjustly"]) > 0:
                    agent_stats[agent_1_idx]["prev_direct_punish_unjustly_select"].append((agent_2_idx, agent_stats[agent_2_idx]["direct_punish_unjustly"][-1]))
            is_terminal_round = 0
            for round_idx in range(num_rounds):
                ...
                direct_punish_reward_1, play_reward_1, agent_stats = perform_punishment(direct_punish_action_idx_1,
                                                                                        play_action_idx_1,
                ...
                direct_punish_reward_2, play_reward_2, agent_stats = perform_punishment(direct_punish_action_idx_2,
                                                                                        play_action_idx_2,
                ...
                punish_reward_1, play_reward_1, agent_stats = perform_punishment(tpp_punish_action_idx_1,
                                                                                 play_action_idx_1,
                ...
                punish_reward_2, play_reward_2, agent_stats = perform_punishment(tpp_punish_action_idx_2,
                                                                                 play_action_idx_2,
    ...
    if logging:
        with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Logs',
                               'play_ttpdp_s_play_punish_rep_rep_in_play_state.json'), 'w+', encoding='utf-8') as f:
...
if __name__ == "__main__":
    ...
    mean_combined_sum_reward, agent_stats = play_ttpdp_s_play_punish_rep_rep_in_play_state(cooperation_game, 1000, 10,
                                                                                         population)
