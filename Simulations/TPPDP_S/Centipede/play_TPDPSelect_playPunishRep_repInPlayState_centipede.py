# Reputation impacted by playing and punishing behaviour. Play actions also depend on reputation (play state).
...
def play_ttpdp_s_play_play_punish_rep_rep_in_play_state(num_eps: int, max_num_rounds: int,
        ...
        for agent_1_idx, agent_1 in enumerate(population):
            ...
            for round_index in range(max_num_rounds):
                ...
                if cur_agent_turn == 0:
                    ...
                    direct_punish_action_idx_1 = agent_2.punish_model.select_action(punish_state_1)
                    direct_punish_reward_1, running_reward_1, agent_stats = perform_punishment(direct_punish_action_idx_1,
                                                                                        play_action_idx_1,
                                                                                        agent_2_idx,
                                                                                        running_reward_1,
                    ...
                    update_reputation_using_punish_action(punish_action_idx_1, play_action_idx_1, punisher_1_idx,
                                                          agent_reputations)
                    update_reputation_using_punish_action(direct_punish_action_idx_1, play_action_idx_1, agent_2_idx,
                                                          agent_reputations)

                    combined_punishers_reward += punish_reward_1
                    combined_punishers_reward += direct_punish_reward_1
                    ...
                    direct_punish_exp_1 = (punish_state_1, direct_punish_action_idx_1, direct_punish_reward_1, new_direct_punish_state_1,
                                    is_terminal_round)
                    agent_2.punish_model.replay_buffer.store(*direct_punish_exp_1)
                ...
                if stop_activated:
                    ...
                    direct_punish_action_idx_2 = agent_1.punish_model.select_action(punish_state_2)

                    direct_punish_reward_2, running_reward_2, agent_stats = perform_punishment(direct_punish_action_idx_2,
                                                                                        play_action_idx_2,
                                                                                        agent_1_idx,
                                                                                        running_reward_2,
                                                                                        agent_reputations, agent_stats,
                    ...
                    combined_punishers_reward += direct_punish_reward_2
                    ...
                    direct_punish_exp_2 = (punish_state_2, direct_punish_action_idx_2, direct_punish_reward_2, new_direct_punish_state_2,
                                    is_terminal_round)
                    agent_1.punish_model.replay_buffer.store(*direct_punish_exp_2)
    ...
    if logging:
        with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Logs',
                               'play_ttpdp_s_play_play_punish_rep_rep_in_play_state.json'), 'w+', encoding='utf-8') as f:
...
if __name__ == "__main__":
    ...
    mean_combined_sum_reward, agent_stats = play_ttpdp_s_play_play_punish_rep_rep_in_play_state(10, 2, population)
