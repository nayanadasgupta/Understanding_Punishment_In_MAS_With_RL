...
from play_TPDPSelect_playPunishRep_repInPlayState_centipede import play_ttpdp_s_play_play_punish_rep_rep_in_play_state
...
if __name__ == "__main__":
    game_name = "play_ttpdp_s_play_play_punish_rep_rep_in_play_state_centipede"
    run_stats = []
    ...
    for run in tqdm(range(NUM_RUNS)):
        ...
        mean_combined_sum_reward, agent_stats = play_ttpdp_s_play_play_punish_rep_rep_in_play_state(NUM_EPISODES,
                                                                                               NUM_ROUNDS,
                                                                                               population)
        print()
