...
from play_Costly_Punish_TPDPOnly_playPunishRep_repInPlayState_pd import play_costly_punish_ttpdp_play_punish_rep_rep_in_play_state
...
if __name__ == "__main__":
    game_name = "play_costly_punish_ttpdp_play_punish_rep_rep_in_play_state"
    run_stats = []
    ...
    for run in tqdm(range(NUM_RUNS)):
        ...
        mean_combined_sum_reward, agent_stats = play_costly_punish_ttpdp_play_punish_rep_rep_in_play_state(cooperation_game,
                                                                                               NUM_EPISODES,
                                                                                               NUM_ROUNDS,
                                                                                               population)
        print()
