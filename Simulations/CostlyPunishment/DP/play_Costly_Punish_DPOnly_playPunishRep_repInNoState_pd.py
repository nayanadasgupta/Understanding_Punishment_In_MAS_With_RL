...
from Mechanisms.Punishment import perform_costly_punishment
...
def play_costly_punish_dp_play_punish_rep_rep_in_no_state(cooperation_dilemma: MatrixGame, num_eps: int, num_rounds: int,
    ...
    for episode in tqdm(range(num_eps)):
        ...
        for agent_1_idx, agent_1 in enumerate(population):
            ...
            for round_idx in range(num_rounds):
                ...
                punish_reward_1, play_reward_1, agent_stats = perform_costly_punishment(punish_action_idx_1, play_action_idx_1,
                ...
                punish_reward_2, play_reward_2, agent_stats = perform_costly_punishment(punish_action_idx_2, play_action_idx_2,
    ...
    if logging:
        with open(os.path.join(os.path.dirname(os.path.realpath(__file__)), 'Logs', 'play_costly_punish_dp_play_punish_rep_rep_in_no_state.json'), 'w+', encoding='utf-8') as f:
...
if __name__ == "__main__":
    ...
    mean_combined_sum_reward, agent_stats = play_costly_punish_dp_play_punish_rep_rep_in_no_state(cooperation_game, 1000,
                                                                                      10, population)
