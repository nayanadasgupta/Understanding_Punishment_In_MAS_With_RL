...
from play_TPPSelect_playPunishRep_repInPlayState_centipede import play_ttp_s_play_play_punish_rep_rep_in_play_state
...
if __name__ == "__main__":
    game_name = "play_ttp_s_play_play_punish_rep_rep_in_play_state"
    run_stats = []
    ...
    for run in tqdm(range(NUM_RUNS)):
        ...
        mean_combined_sum_reward, agent_stats = play_ttp_s_play_play_punish_rep_rep_in_play_state(NUM_EPISODES,
                                                                                                  NUM_ROUNDS,
                                                                                                  population)
        print()
