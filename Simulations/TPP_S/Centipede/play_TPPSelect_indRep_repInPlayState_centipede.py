...
def play_ttp_s_play_ind_rep_rep_in_play_state(num_eps: int, max_num_rounds: int,
    ...
    for episode in tqdm(range(num_eps)):
        ...
        for agent_1_idx, agent_1 in enumerate(population):
            ...
            for round_index in range(max_num_rounds):
                ...
                if stop_activated:
                    ...
                    new_play_state_2 = [agent_prev_play_actions[agent_1_idx], play_action_idx_2,
                                        agent_reputations[agent_2_idx][agent_1_idx],
            ...
            select_exp_1 = (select_state[agent_1_idx], possible_partner_idx, running_reward_1, new_select_state_1[agent_1_idx], is_terminal_round)
