...
from play_TPPSelect_punishOnlyRep_repInPlayState_centipede import play_ttp_s_play_punish_only_rep_rep_in_play_state
...
if __name__ == "__main__":
    ...
    for run in tqdm(range(NUM_RUNS)):
        ...
        mean_combined_sum_reward, agent_stats = play_ttp_s_play_punish_only_rep_rep_in_play_state(NUM_EPISODES,
                                                                                                  NUM_ROUNDS,
                                                                                                  population)
        print()
