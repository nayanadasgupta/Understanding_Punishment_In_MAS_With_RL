...
def play_ttp_s_play_only_rep_rep_in_play_state(cooperation_dilemma: MatrixGame, num_eps: int, num_rounds: int,
    ...
    if logging:
        with open("Logs/play_ttp_s_play_only_rep_rep_in_play_state.json", 'w+', encoding='utf-8') as f:
