...
from play_TPPSelect_playPunishRep_repInPunishState_pd import play_ttp_s_play_punish_rep_rep_in_punish_state
...
if __name__ == "__main__":
    game_name = "play_ttp_s_play_punish_rep_rep_in_punish_state"
    run_stats = []
    ...
    for run in tqdm(range(NUM_RUNS)):
        ...
        mean_combined_sum_reward, agent_stats = play_ttp_s_play_punish_rep_rep_in_punish_state(cooperation_game,
                                                                                               NUM_EPISODES,
    ...
    with open(f"Simulations/TPP_S/IPD/Results/run_stats_{game_name}_{NUM_RUNS}_{NUM_EPISODES}_{NUM_ROUNDS}_{NUM_AGENTS}_agents.txt", 'w') as f:
